...
const Trip = ({error, name, image, cost, days, description, country, intro, id}) => {  // 1
      ...
      <Grid> 
        <Row>
          <Col xs={12}>
            ...
            <OrderForm tripCost={cost} tripId={id} tripName={name} tripCountry={country}/>    {/* 2 */}
          </Col>
        </Row>
      </Grid>
      <Grid>
